...
对应 [阿里规范《命名风格》一章](docs/ali1.3.1.pdf)
...
| 6. 常量命名全部大写| | 扩写规则|
| 8. 命名命名的好坏，在于其“模糊度”| 11. 为了达到代码自解释的目标 | 扩写规则，参考《Clean Code》的更多例子|
...
对应 [阿里规范《代码格式》一章](docs/ali1.3.1.pdf)
...
对应 [阿里规范《注释规约》一章](docs/ali1.3.1.pdf)
...
* 规则 6，7，12，13 从[阿里规范《控制语句》一章](docs/ali1.3.1.pdf) 移入
* 规则 9 从[阿里规范《异常处理》一章](docs/ali1.3.1.pdf) 移入
...
对应 [阿里规范《OOP规约》一章](docs/ali1.3.1.pdf)
...
对应 [阿里规范《控制语句》一章](docs/ali1.3.1.pdf)
...
对应 [阿里规范《集合处理》一章](docs/ali1.3.1.pdf)
...
对应 [阿里规范《并发处理》一章](docs/ali1.3.1.pdf)
...
对应 [阿里规范《异常处理》一章](docs/ali1.3.1.pdf)
...
对应 [阿里规范《日志规约》一章](docs/ali1.3.1.pdf)
...
保留 [阿里规范《常量定义》一章](docs/ali1.3.1.pdf)的规则1
...
保留 [阿里规范《其他》一章](docs/ali1.3.1.pdf)的规则7
